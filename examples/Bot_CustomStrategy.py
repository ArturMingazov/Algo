...
# from the main Algotrading folder
...
def customEntryStrategy(bot_controller, symbol):
    ## This is the function that Algotrading will call to check for entry signal
    ...
    ##      written to work with Algotrading plus all the ccxt unified api methods,
